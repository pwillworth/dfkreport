...
def valueFromWei(amount, token):
    ...
    if token in ['0x3095c7557bCb296ccc6e363DE01b760bA031F2d9', '0xdc54046c0451f9269FEe1840aeC808D36015697d','0x7516EB8B8Edfa420f540a162335eACF3ea05a247']:
        ...
        if token in ['0x3a4EDcf3312f44EF027acfd8c21382a5259936e7','0x576C260513204392F0eC0bc865450872025CB1cA','0xe7a1B580942148451E47b92e95aEB8d31B0acA37']: # DFKGOLD
            weiConvert = 'kwei'
...
def getNativeToken(network):
    if network == 'klaytn':
        return '0xe4f05A66Ec68B54A58B17c22107b02e0232cC817'
...
address_map = {
    ...
    '0x5819b6af194a78511c79c85ea68d2377a7e9335f': 'wKlay', # Start Klaytn List
    ...
    '0xaA8548665bCC12C202d5d0C700093123F2463EA6': 'Jeweler Serendale',
...
gold_values = {
    ...
    '0xe7a1B580942148451E47b92e95aEB8d31B0acA37': 0, #DFKGold Klay
    '0x8Be0cbA3c8c8F392408364ef21dfCF714A918234': 0, #Gaia's Tears Klay
    ...
    '0x907a98319AEB249e387246637149f4B2e7D21dB7': 0, #'Shvas Rune', #klatn quest items
    ...
    '0xa27C1429a676db902B9f0360686eDbB57d0A7B01': 0, #'Health Vial', # Klaytn crafted items
    ...
    '0x80Ab38fc9fA0a484b98d5600147e7C695627747D': 0, #'Lesser Might Crystal', # Klaytn crystals
    ...
    '0xbb8ac0BB95E433204217b0478B3f6d815EcB2d8C': 0, #'Lesser Might Stone', # Klaytn stones
...
RUNE_TOKENS = {
    ...
    '0xCd2192521BD8e33559b0CA24f3260fE6A26C28e4': 'Moksha Rune',
    '0x907a98319AEB249e387246637149f4B2e7D21dB7': 'Shvas Rune', #klatn
    '0xd0223143057Eb44065e789b202E03A5869a6006C': 'Moksha Rune',
}
