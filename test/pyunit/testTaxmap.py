...
class testTaxmap(unittest.TestCase):
	...
	def test_buildSwapRecords(self):
		# act
		taxRecords = taxmap.buildSwapRecords(self.em['swaps'], self.yearStart, self.yearEnd, self.em['wallet'], self.em['airdrops'], self.em['gardens'], self.em['quests'], 'fifo', ['0xPURCHASE'])
